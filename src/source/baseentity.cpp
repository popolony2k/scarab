 ...
 */
void BaseEntity :: SetDimension2DPtr( stDimension2D* pDimension )  {
 ...
 */
void BaseEntity :: SetDimension2D( stDimension2D dimension )  {
 ...
 */
stDimension2D& BaseEntity :: GetDimension2D( void )  {
